# nvim-treesitter-queries-tsv

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tsv/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tsv/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tsv**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tsv",
...
- [ ] Changes are scoped to `tsv` — do not include files for other languages
